...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('customer_models', function (Blueprint $table) {
            ...
            $table->integer('overdrawn_fees_in_30_days')->nullable();
            $table->integer('overdrawn_fees_in_80_days')->nullable();
            $table->integer('overdrawn_fees_in_90_days')->nullable();
            $table->integer('overdrawn_fees_in_180_days')->nullable();
            $table->integer('overdrawn_fees_total')->nullable();

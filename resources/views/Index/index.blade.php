...
<div class="row gx-4">
    ...
    <div class="col-lg-6 mb-4">
        <div class="panel ai-loan-matching p-4 rounded-3 shadow-sm position-sticky" style="top: 70px; z-index: 1000;margin-bottom:10px;border: 3px solid #d8b4fe;">
            <div class="col-md-12 ">
                <div class="row">
        ...
        <div class="panel ai-loan-matching p-4 rounded-3 shadow-sm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="loan_amt" name="loan_amt" class="form-control" aria-label="Loan Amount Needed">
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
            ...
            <div class="loan-navigation d-flex justify-content-between align-items-center mt-4">
                <button class="btn btn-green btn-arrow rounded-circle btn-prev-global me-2">
                ...
                <div class="loan-info d-flex gap-2">
                    <div class="loan-info-box border border-2 rounded-2 p-2 text-center from-box">
                        ...
                        <div class="small from-frequency">PER WEEK</div>
                ...
                <button class="btn btn-green btn-arrow rounded-circle btn-next-global">
                    <i id="next_btn" class="bi bi-chevron-right"></i>
                </button>
            </div>
    ...
    <!-- Right Panel -->
    <div class="col-lg-6 mb-4">
        <div class="panel ebroker-lender-panel p-4 rounded-3 shadow-sm position-sticky" style="top: 90px; z-index: 1000;">
            <div class="panel-header text-center mb-3">

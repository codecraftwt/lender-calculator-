                ...
                <form method="POST" action="{{ url('/save_data') }}" id="lender_form" class="car-bike-boat-form">
                    ...
                    <div class="step step-2 d-none" data-step="2">
                        ...
                        <div class="row">
                            ...
                            <textarea type="text" id="applicable_lenders" cols="20" rows="20" name="applicable_lenders" class="form-control " required></textarea>
                        </div>
...
<script src="{{ url('assets/js/broker.js') }}"></script>
